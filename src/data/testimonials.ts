...
export const testimonialsData: TestimonialItem[] = [
  ...
  },
  {
    ...
    rating: 5,
    date: 'March 2026',
    quote: 'In the Southern California summer, our old pool deck was burning our feet. The light travertine pavers stay dramatically cooler, and the pet turf has solved all of our dog mud issues. Financing at 0% made this an absolute no-brainer.',
    verified: true,
  },
  {
    id: 't4',
