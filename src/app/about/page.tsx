      ...
      <main className="flex-1">
        ...
        <section className="relative w-full h-[50vh] min-h-[380px] max-h-[500px] overflow-hidden bg-stone-950 text-white flex flex-col justify-between">
          ...
          <div className="relative z-20 flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 max-w-5xl mx-auto my-auto">
            ...
            >
              Engineering Architectural Outdoor Living Across Southern California
            </h1>
        ...
        {/* ==================================================================== */}
        {/* 2. SECTION 1: QUIÉNES SOMOS (WHO WE ARE)                             */}
        {/* ==================================================================== */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <p className="text-stone-600 text-base sm:text-lg leading-relaxed">
                  Founded in Southern California in 1998, <strong>American Pavers &amp; Turf</strong> was established to end the frustrating cycle of cracked poured concrete driveways, deteriorating patios, and water-wasting lawns.
                </p>
              ...
              {/* Right Column: Real Image matching full height of left column, without text overlay */}
        ...
        {/* ==================================================================== */}
        {/* 3. SECTION 2: QUÉ HACEMOS (WHAT WE DO)                               */}
        {/* ==================================================================== */}
        <section className="py-20 bg-stone-50 text-stone-900 border-b border-stone-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Services Cards Grid — exact replica of the home block */}
        ...
        {/* ==================================================================== */}
        {/* 5. FREQUENTLY ASKED QUESTIONS ABOUT US                               */}
        {/* ==================================================================== */}
        <FaqAccordion
          faqs={generalFaqs}
