      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6 mb-12 sm:mb-16">
          ...
          <button
            ...
            className="px-6 py-3.5 bg-stone-100 hover:bg-stone-200 text-[#1A292C] font-semibold text-xs sm:text-sm uppercase tracking-wider rounded border border-stone-300 transition-colors flex items-center gap-2 cursor-pointer"
          >
        ...
        {/* Mosaic Grid */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 auto-rows-[240px] sm:auto-rows-[280px]">
