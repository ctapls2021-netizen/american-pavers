  ...
  return (
    <section id="services" className="py-20 sm:py-28 bg-stone-100/70 text-stone-900 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header (No tabs, clean typography) */}
        ...
        {/* Services Grid (All 6 services displayed directly, no tabs, no subpage navigation) */}
          ...
          {servicesCatalog.map((service) => (
            ...
            >
              ...
              <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between">
                ...
                {/* Card Conversion Action — Instant Modal Trigger */}
        ...
        {/* Bottom Multi-Service Banner (Clean, no sparkle/star icons) */}
