...
const DEFAULT_VIDEO = "/videos/hero-backyard-pavers.mp4"
...
export default function BackyardMetroSection({
  videoSrc = DEFAULT_VIDEO,
  title = "CALIFORNIA RESORT LIVING",
  scrollHint = "SCROLL",
  tagline = "Custom synthetic turf & luxury pavers built to last generations.",
  signature = false,
  scrubDistance = 3500,
  className,
  style,
  ...
  useEffect(() => {
    ...
    // Lock immediately if at top on mount (though this is typically a middle section)
    if (window.scrollY <= 5) {
      engageLock()
    }
